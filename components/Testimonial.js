              ...
              <div className="col-lg-4">
                <div className="testimonials-content-part rel z-2 rmb-55 wow fadeInUp delay-0-2s">
                  <div className="section-title mb-40">
                    ...
                    <h2>
                      My Clients <span>Feedback</span> and
                      <span> Success Stories</span>
                    </h2>
                    <p>
                      Discover client&apos;s stories of success with my tailored
                      software solutions. Real testimonials showcasing
                      transformative experiences and exceptional outcomes.
                    </p>
                  </div>
